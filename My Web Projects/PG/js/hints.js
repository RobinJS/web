define(function (require) {
	...
	Hints.prototype.showBetHint = function(){
		this.changeText( this.TEXTS.BET );
	};

	Hints.prototype.changeText = function( text ){
		var that = this;

		TweenMax.to( this.hintText, 0.2, { opacity: 0, onComplete: function(){
			that.hintText.setText(text);
			that.hintText.updateTransform();
			that.hintText.x = settings.gameWidth/2 - that.hintText.width/2 + 90;
			TweenMax.to(that.hintText, 0.2, { opacity: 1 });
		}});
